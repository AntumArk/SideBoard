...
extern inline void blockPWM(int pwm, int pos, int *u, int *v, int *w)
{
  switch (pos)
  {
  case 0:
...
extern inline void blockPhaseCurrent(int pos, int u, int v, int *q)
{
  switch (pos)
  {
  case 0:
...
void DMA1_Channel1_IRQHandler()
{
  ...
  { // because you get float rounding errors if it would run every time
